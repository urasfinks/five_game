bridge.log("BattleOfMinds/GameFunction.js included");

bridge.global.BattleOfMinds = {};
bridge.global.BattleOfMinds.getGridWord = function(socketData) {
    var listCard = [];
    ...
    for (var c = 0; c < matrix.row; c++) {
        ...
        for (var i = 0; i < matrix.col; i++) {
            ...
            var onTap = (canBePressed && cardData["selected"] == null) ? {
                "jsInvoke": "BattleOfMinds/GameRun.js",
                "args": {
                    "includeAll": true,
                    "switch": "onCardTap",
                    "index": counter - 1
...
bridge.global.BattleOfMinds.getUsers = function(socketData) {
    var reds = [], blues = [];
    for (var key in socketData) {
...
bridge.global.BattleOfMinds.calculateScore = function(socketData, newStateData, socketUuid) {
...
bridge.global.BattleOfMinds.getListPersonGroup = function(socketData, team, socketUuid) {
    var result = [];
...
bridge.global.BattleOfMinds.getFlagToWordGameState = function(socketData, state) {
